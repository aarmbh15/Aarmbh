    ...
    <div className="min-h-screen bg-[#050505] text-white font-sans selection:bg-amber-500/30 overflow-x-hidden">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-5">
                  {filtered.map((project) => (
                    ...
                    >
                      ...
                      <div className="relative aspect-video overflow-hidden">
                        <img src={project.image} className="w-full h-full object-cover grayscale opacity-20 group-hover:opacity-100 group-hover:grayscale-0 transition-all duration-700" alt={project.title} />
                        <div className="absolute inset-0 bg-gradient-to-t from-[#080808] to-transparent opacity-60" />
                      </div>
      ...
      <section className="py-16 md:py-32 bg-[#050505]">
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-12 md:mb-16 gap-6 md:gap-8">
            <div className="border-l border-amber-500/50 pl-6">
              <h2 className="text-[9px] md:text-[10px] uppercase tracking-[0.6em] md:tracking-[0.8em] text-amber-500 font-bold mb-2">Stability</h2>
              <p className="text-2xl md:text-3xl font-light text-white">Active Retainers.</p>
            </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-px bg-white/10 border border-white/10 overflow-hidden rounded-2xl md:rounded-3xl">
            {MAINTENANCE.map((item, i) => (
              <div key={i} className="bg-[#080808] p-8 md:p-10 group hover:bg-amber-500/[0.02] transition-all duration-500">
                <span className="text-2xl md:text-3xl mb-6 md:mb-8 block">{item.icon}</span>
                <h3 className="text-white font-medium mb-1 tracking-tight text-sm md:text-base">{item.title}</h3>
                <p className="text-amber-500/50 text-[8px] md:text-[9px] uppercase tracking-widest mb-6 md:mb-8">{item.type}</p>
                <div className="flex justify-between items-center pt-4 md:pt-6 border-t border-white/5">
                   <span className="font-mono text-[8px] md:text-[9px] text-slate-700">EST_{item.since}</span>
                   <span className="text-[9px] md:text-[10px] text-slate-400 group-hover:text-amber-500 transition-colors flex items-center gap-1.5">LIVE <FiGlobe className="text-[8px]" /></span>
                </div>
              </div>
            ))}
          </div>
      ...
      <section className="py-20 md:py-32 bg-[#050505] relative text-center px-6">
        ...
        <div className="relative z-10 max-w-4xl mx-auto">
          <p className="text-amber-500 font-mono text-[9px] md:text-[10px] uppercase tracking-[0.3em] md:tracking-[0.5em] mb-6 md:mb-8">Ready to Scale?</p>
          ...
          >
            <span className="text-[9px] md:text-[10px] uppercase tracking-[0.4em] md:tracking-[0.5em] font-bold">Initiate Deployment</span>
            <div className="w-8 h-8 md:w-10 md:h-10 rounded-full bg-amber-500 flex items-center justify-center text-black group-hover:translate-x-2 transition-transform">→</div>
          </button>
        </div>
      </section>
      ...
      <div className="py-6 md:py-8 border-t border-white/5 flex justify-center items-center gap-3 md:gap-4 bg-[#050505] px-6 text-center">
        ...
        <span className="font-mono text-[8px] md:text-[9px] text-slate-700 uppercase tracking-[0.3em] md:tracking-[0.4em]">Portfolio Integrity Verified // 2026</span>
      </div>
